...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <link href="<?php echo base_url();?>./assets/adminassets/css/lib/unix.css" rel="stylesheet">
    <link href="<?php echo base_url();?>./assets/adminassets/css/style.css" rel="stylesheet">
     <script src="<?php echo base_url();?>assets/adminassets/js/lib/chart-js/Chart.bundle.js"></script>
    <script src="<?php echo base_url();?>assets/adminassets/js/lib/chart-js/chartjs-init.js"></script>
